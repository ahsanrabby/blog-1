...
<head>
    ...
    <link href="{{asset('admin-asset')}}/assets/plugins/datatable/css/dataTables.bootstrap5.min.css" rel="stylesheet" />
...
<script src="{{asset('admin-asset')}}/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
<script src="{{asset('admin-asset')}}/assets/plugins/datatable/js/dataTables.bootstrap5.min.js"></script>
<script src="{{asset('admin-asset')}}/assets/js/table-datatable.js"></script>
